...
namespace ImageDebugger.Core.ViewModels.CameraViewModel
{
    /// <summary>
    ...
    public static class HKCameraManager
    {
        ...
        /// </summary>
        public static List<global::ImageDebugger.Core.ViewModels.CameraViewModel.CameraViewModel> AttachedCameras { get; private set; }
        ...
        /// <returns></returns>
        public static global::ImageDebugger.Core.ViewModels.CameraViewModel.CameraViewModel GetCameraByName(string name)
        {
        ...
        {
            AttachedCameras = new List<global::ImageDebugger.Core.ViewModels.CameraViewModel.CameraViewModel>();
            ...
            for (int i = 0; i < cameraInfos.Count; i++)
            {
                ...
                AttachedCameras.Add(new global::ImageDebugger.Core.ViewModels.CameraViewModel.CameraViewModel()
                {
                    Name = cameraName,
